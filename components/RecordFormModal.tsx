...
export const RecordFormModal: React.FC<RecordFormModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Build only writable Salesforce fields. CaseNumber is generated by
    // Salesforce and must never be sent in POST/PUT requests.
    const payload: Record<string, any> = {};
    config.fields.forEach((f) => {
      if (config.id === 'Case' && f.key === 'caseNumber') return;
